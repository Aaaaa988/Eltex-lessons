...
public class DevAndLang implements Serializable {

    private static final long serialVersionUID = 693228321;

    private final Integer idDev;
    private final Integer idLang;

    public DevAndLang(DevAndLang value) {
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("DevAndLang (");
