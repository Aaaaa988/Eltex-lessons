...
public class Developers extends TableImpl<DevelopersRecord> {
    ...
    private static final long serialVersionUID = 850179038;
    ...
    /**
     * The column <code>Developers.name</code>.
     */
    public final TableField<DevelopersRecord, String> NAME = createField("name", org.jooq.impl.SQLDataType.VARCHAR(50).nullable(false), this, "");
    ...
    public UniqueKey<DevelopersRecord> getPrimaryKey() {
        return Internal.createUniqueKey(ru.eltex.database.tables.Developers.DEVELOPERS, "KEY_Developers_PRIMARY", ru.eltex.database.tables.Developers.DEVELOPERS.ID);
    }
    ...
    public List<UniqueKey<DevelopersRecord>> getKeys() {
        return Arrays.<UniqueKey<DevelopersRecord>>asList(
              Internal.createUniqueKey(ru.eltex.database.tables.Developers.DEVELOPERS, "KEY_Developers_PRIMARY", ru.eltex.database.tables.Developers.DEVELOPERS.ID)
        );
    }
